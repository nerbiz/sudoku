...
function Controls() {
  ...
  if (_Utilities_Visitor__WEBPACK_IMPORTED_MODULE_0__["default"].usesMacOs()) {
  ...
  self.init = function () {
    ...
    document.addEventListener('keydown', function (event) {
      if (event.ctrlKey) self.ctrlKeys.forEach(function (ctrlKey) {//
      });
    });
  };
}
...
throw new Error("Module build failed (from ./node_modules/babel-loader/lib/index.js):\nError: ENOENT: no such file or directory, open '/Applications/MAMP/htdocs/private/sudoku/assets/js/Utilities/Visitor.js'");
