...
function Clock() {
  ...
  self.enableTimeInterval = function () {
...
function AutoCandidateModeCommand() {
  ...
  self.state = function () {
    return Sudoku.settings.autoCandidateModeState();
  };
  /**
   * @inheritDoc
   */
...
/***/ "./assets/js/Commands/DesignModeCommand.js":
/*!*************************************************!*\
  !*** ./assets/js/Commands/DesignModeCommand.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DesignModeCommand; });
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions */ "./assets/js/functions.js");
/* harmony import */ var _TogglableCommandInterface__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./TogglableCommandInterface */ "./assets/js/Commands/TogglableCommandInterface.js");


Object(_functions__WEBPACK_IMPORTED_MODULE_0__["extend"])(DesignModeCommand, _TogglableCommandInterface__WEBPACK_IMPORTED_MODULE_1__["default"]);
function DesignModeCommand() {
  var self = this;
  _TogglableCommandInterface__WEBPACK_IMPORTED_MODULE_1__["default"].call(self);
  /**
   * @inheritDoc
  ...
  self.state = function () {
    return Sudoku.settings.designModeState();
  };
  /**
   * @inheritDoc
   */
...
function Controls() {
  ...
  self.isNumberKey = function (event) {
  ...
  self.isDeleteKey = function (event) {
    return _deleteKeys.indexOf(event.code) > -1;
  };
  /**
  ...
  self.isArrowKey = function (event) {
    ...
    return _arrowKeys[direction] && _arrowKeys[direction].indexOf(event.code) > -1;
  };
}
...
/* harmony import */ var _Commands_DesignModeCommand__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../Commands/DesignModeCommand */ "./assets/js/Commands/DesignModeCommand.js");
...
function ActionsEventHandler() {
  ...
  var _registerPauseResumeEvent = function _registerPauseResumeEvent() {
    ...
    document.getElementById('game-resume-button').addEventListener('click', function () {
      new _Commands_PauseGameCommand__WEBPACK_IMPORTED_MODULE_1__["default"]().execute(false);
      Sudoku.modal.close();
    });
  };
  /**
  ...
  var _registerAutoCandidateModeEvent = function _registerAutoCandidateModeEvent() {
    document.getElementById('setting-auto-candidate').addEventListener('change', function (event) {
      new _Commands_AutoCandidateModeCommand__WEBPACK_IMPORTED_MODULE_0__["default"]().execute(event.target.checked);
    });
  };
  /**
   * @private
  ...
  var _registerDesignModeEvent = function _registerDesignModeEvent() {
    document.getElementById('toggle-design-mode').addEventListener('change', function (event) {
      new _Commands_DesignModeCommand__WEBPACK_IMPORTED_MODULE_2__["default"]().execute(event.target.checked);
    });
  };
}
...
function GridCell(cellNumber) {
  ...
  self.isPrefilled = function () {
    ...
    if (state !== null) {
      _isPrefilled = state; // Toggle the CSS class of the prefilled state

      var toggleMethod = state === true ? 'add' : 'remove';
  ...
  self.setDigit = function (digit) {
    ...
    if (digit === null) {
      ...
      if (self.getValue() === null) {
        self.getCornerMarks().setDigits([]); // Don't remove player filled center marks in auto candidate mode
...
function CenterMarks(cell) {
  ...
  self.toggleDigit = function (digit) {
    ...
    if (self.cell.isPrefilled() === true || Sudoku.settings.autoCandidateModeState() === true) {
      return;
  ...
  self.has = function (digit) {
    var centerMarks = Sudoku.settings.autoCandidateModeState() === true ? self.getAutoCandidates() : self.get();
...
function InputMode() {
  ...
  var _inputModeValueLabel = document.getElementById('input-mode-value-label');
  /**
  ...
  var _inputModeCornerLabel = document.getElementById('input-mode-corner-label');
  /**
  ...
  self.setMode = function (mode) {
    ...
    var maxModeNumber = Sudoku.settings.autoCandidateModeState() === true ? // Center-marks are disabled in auto-candidate mode
  ...
  var _disableInput = function _disableInput(label) {
  ...
  self.triggerAutoCandidateModeActions = function (state) {
    if (state === true) {
      _disableInput(_inputModeCenterLabel, true); // Trigger any restrictions on the current input mode
  ...
  self.triggerDesignModeActions = function (state) {
    if (state === true) {
...
function Settings() {
  ...
  var _autoCandidateModeState = false;
  /**
  ...
  self.autoCandidateModeState = function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
